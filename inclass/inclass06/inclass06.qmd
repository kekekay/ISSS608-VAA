...
```{r}
pacman::p_load(tidyverse,readtext,corporaexplorer,quanteda,tidytext,readr)
```
...
[Prepare data for corpus exploration](https://kgjerde.github.io/corporaexplorer/reference/prepare_data.html)

```{r}
#to double confirm the object has been created succesfully 
class(KJB)
```
